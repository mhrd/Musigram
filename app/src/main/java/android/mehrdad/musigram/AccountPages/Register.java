...
//    private SQLiteHandler db;
    ...
    EditText email, name, username, pass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login = (TextView) findViewById(R.id.log_btn);
...
//        db = new SQLiteHandler(getApplicationContext());
        ...
        sign_up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String s_password = pass.getText().toString().trim();
                String s_username = username.getText().toString().trim();

                if (!s_name.isEmpty() && !s_email.isEmpty() && !s_password.isEmpty() && !s_username.isEmpty()) {
                    registerUser(s_email, s_name, s_password, s_username);
                } else {
